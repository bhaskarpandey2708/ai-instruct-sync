...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`auth-anomaly-radar (P09) — Lightweight auth anomaly detection for SaaS (impossible travel, credential stuffing signals)

Usage:
  auth-anomaly-radar [--json] [fixture.json]
  auth-anomaly-radar --help
...
if (json) console.log(JSON.stringify({ product: "auth-anomaly-radar", id: "P09", result }, null, 2));
else {
  console.log("auth-anomaly-radar · P09");
