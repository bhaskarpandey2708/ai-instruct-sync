...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`learn-loop (P19) — Spaced-repetition + cohort homework OS for coaching institutes and online tutors

Usage:
  learn-loop [--json] [fixture.json]
  learn-loop --help
...
if (json) console.log(JSON.stringify({ product: "learn-loop", id: "P19", result }, null, 2));
else {
  console.log("learn-loop · P19");
