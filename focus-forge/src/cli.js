...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`focus-forge (P27) — Deep-work OS: site blocker + session goals + AI weekly review for knowledge workers

Usage:
  focus-forge [--json] [fixture.json]
  focus-forge --help
...
if (json) console.log(JSON.stringify({ product: "focus-forge", id: "P27", result }, null, 2));
else {
  console.log("focus-forge · P27");
