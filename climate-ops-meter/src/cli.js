...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`climate-ops-meter (P25) — Lightweight Scope 1–3 carbon estimate and supplier survey tool for mid-market exporters

Usage:
  climate-ops-meter [--json] [fixture.json]
  climate-ops-meter --help
...
if (json) console.log(JSON.stringify({ product: "climate-ops-meter", id: "P25", result }, null, 2));
else {
  console.log("climate-ops-meter · P25");
