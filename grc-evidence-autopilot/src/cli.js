...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`grc-evidence-autopilot (P14) — Auto-collect compliance evidence (access logs, policies, screenshots) for SOC2/ISO startups

Usage:
  grc-evidence-autopilot [--json] [fixture.json]
  grc-evidence-autopilot --help
...
if (json) console.log(JSON.stringify({ product: "grc-evidence-autopilot", id: "P14", result }, null, 2));
else {
  console.log("grc-evidence-autopilot · P14");
