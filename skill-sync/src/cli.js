...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`skill-sync (P06) — Package, version, and sync agent skills/tools/prompts like packages across teams

Usage:
  skill-sync [--json] [fixture.json]
  skill-sync --help
...
if (json) console.log(JSON.stringify({ product: "skill-sync", id: "P06", result }, null, 2));
else {
  console.log("skill-sync · P06");
