...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`personal-crm (P23) — Privacy-first personal CRM for founders: follow-ups, context notes, birthday nudges

Usage:
  personal-crm [--json] [fixture.json]
  personal-crm --help
...
if (json) console.log(JSON.stringify({ product: "personal-crm", id: "P23", result }, null, 2));
else {
  console.log("personal-crm · P23");
