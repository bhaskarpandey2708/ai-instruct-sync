...
STORIES: dict[str, DocStory] = {
    ...
    "wa-ops-desk": DocStory(
        slug="wa-ops-desk",
        npm="@bhaskarauthor/wa-ops-desk",
        accent=(37, 211, 102),  # WA green
        cold_claim="Three WhatsApp threads. Three labels. One overloaded inbox.",
        cold_cards=[
            ("orders", "refund #4821", "route → orders desk", AMBER),
            ("booking", "book tomorrow 3pm", "route → booking", CYAN),
            ("faq", "how do I reset…", "auto-FAQ reply", GREEN),
        ],
        chapter1_title="01  ·  THE INBOX PILE",
        chapter1_lines=[
            "Every SME WhatsApp is a second office.",
            "Orders, bookings, FAQs — same blue ticks.",
            "The founder is the router.",
            "",
            "More headcount is one answer.",
            "Label + least-load routing is cheaper first.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Missed refunds become chargebacks and trust loss.",
            "Missed bookings become empty chairs.",
            "Route the message before you hire another pair of eyes.",
        ],
        proof_label="LIVE EVIDENCE  ·  message routing",
        discipline_title="Label. Route. Auto-FAQ when safe.",
        discipline_bullets=[
            "orders · booking · faq · general",
            "least-load assignee from staff labels",
            "Local · zero deps · offline rules",
        ],
        cta_line="Stop treating every chat like a fire.",
        cta_cmd="npx @bhaskarauthor/wa-ops-desk",
        footer="MIT  ·  offline routing core  ·  not WhatsApp Cloud API",
        term_highlight=["orders", "booking", "faq", "assignee", "auto", "routing"],
    ),
    "gst-ops-copilot": DocStory(
        slug="gst-ops-copilot",
        npm="@bhaskarauthor/gst-ops-copilot",
        accent=AMBER,
        cold_claim="Filing week. Three invoices fail hygiene before they fail GSTR.",
        cold_cards=[
            ("gstin", "INV-1002", "bad_gstin", RED),
            ("tax", "INV-1003", "tax_mismatch vs 9%", AMBER),
            ("fields", "INV-1004", "missing_tax lines", RED),
        ],
        chapter1_title="01  ·  THE MESSY BOOKS",
        chapter1_lines=[
            "GSTIN typed wrong.",
            "CGST/SGST don’t match taxable × 9%.",
            "Tax fields missing entirely.",
            "",
            "The CA finds it at filing.",
            "You could have found it in a CLI.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Hygiene issues become notices and rework.",
            "Catch bad_gstin and tax_mismatch early.",
            "Offline checks beat last-night panic.",
        ],
        proof_label="LIVE EVIDENCE  ·  invoice hygiene",
        discipline_title="Invoice hygiene before filing week.",
        discipline_bullets=[
            "GSTIN pattern check",
            "CGST/SGST vs taxable expectation",
            "issue codes for ops cleanup",
        ],
        cta_line="Fail the invoice before the portal does.",
        cta_cmd="npx @bhaskarauthor/gst-ops-copilot",
        footer="MIT  ·  offline hygiene core  ·  not a full GST suite",
        term_highlight=["FAIL", "bad_gstin", "tax_mismatch", "missing_tax", "ISSUES", "CLEAN"],
    ),
    "appt-book-india": DocStory(
        slug="appt-book-india",
        npm="@bhaskarauthor/appt-book-india",
        accent=CYAN,
        cold_claim="WhatsApp says book 3pm. The calendar has three busy blocks.",
        cold_cards=[
            ("busy", "Dr block", "morning held", AMBER),
            ("busy", "existing patient", "midday taken", AMBER),
            ("open", "free slots", "computed · then book", GREEN),
        ],
        chapter1_title="01  ·  THE DOUBLE BOOK",
        chapter1_lines=[
            "Patient messages on WhatsApp.",
            "Reception checks a paper grid.",
            "Two people book the same 3pm.",
            "",
            "Slots are math over busy intervals.",
            "Not vibes over a spreadsheet.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Double books destroy trust faster than late starts.",
            "Compute free slots from busy · then book preferred.",
            "India clinics live on WhatsApp — give them real availability.",
        ],
        proof_label="LIVE EVIDENCE  ·  free slots + book",
        discipline_title="Compute free slots — then book.",
        discipline_bullets=[
            "day window · duration · busy blocks",
            "open SLOT list",
            "book preferred or first free",
        ],
        cta_line="Turn ‘book 3pm’ into a real free slot.",
        cta_cmd="npx @bhaskarauthor/appt-book-india",
        footer="MIT  ·  offline slot core  ·  not a full PMS",
        term_highlight=["SLOT", "OK", "FAIL", "open", "book", "busy"],
    ),
    "clinic-admin-lite": DocStory(
        slug="clinic-admin-lite",
        npm="@bhaskarauthor/clinic-admin-lite",
        accent=(244, 114, 182),
        cold_claim="Patients, appointments, and a charge — one local ledger.",
        cold_cards=[
            ("patient", "Asha K", "consult today", CYAN),
            ("patient", "Rahul M", "bal=₹1200 arrears", AMBER),
            ("charge", "+₹500", "consult fee applied", GREEN),
        ],
        chapter1_title="01  ·  THE PAPER DESK",
        chapter1_lines=[
            "Register in one notebook.",
            "Appointments in another.",
            "Balances in the owner’s head.",
            "",
            "Small clinics don’t need SAP.",
            "They need a ledger that doesn’t lie.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Missed charges and unknown balances compound.",
            "Patients · appts · charges must share one model.",
            "Local-first fits Indian clinic ops reality.",
        ],
        proof_label="LIVE EVIDENCE  ·  ledger snapshot",
        discipline_title="One local ledger for desk ops.",
        discipline_bullets=[
            "patients with balance",
            "appointments linked by patientId",
            "charge updates balance",
        ],
        cta_line="See patients, appts, and balances together.",
        cta_cmd="npx @bhaskarauthor/clinic-admin-lite",
        footer="MIT  ·  offline ledger core  ·  not a full hospital system",
        term_highlight=["bal=", "charge", "patients", "appointments", "₹", "signal"],
    ),
    "learn-loop": DocStory(
        slug="learn-loop",
        npm="@bhaskarauthor/learn-loop",
        accent=CYAN,
        cold_claim="You binge-read notes. The card was due yesterday.",
        cold_cards=[
            ("due", "git-rebase", "due today · new card", AMBER),
            ("due", "http-429", "due today · interval grown", GREEN),
            ("later", "sql-index", "not due · day 12", MUTED),
        ],
        chapter1_title="01  ·  THE BINGE TRAP",
        chapter1_lines=[
            "Highlight everything.",
            "Re-read the same PDF.",
            "Fail the interview card you ‘knew’ last month.",
            "",
            "Memory is a schedule.",
            "Not a highlight color.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Cramming feels productive and expires.",
            "Spaced repetition schedules the next fight with the card.",
            "Due queues beat guilt stacks.",
        ],
        proof_label="LIVE EVIDENCE  ·  SM-2 style schedule",
        discipline_title="Schedule the next review.",
        discipline_bullets=[
            "quality 0–5 updates interval + EF",
            "due queue for today",
            "Local · zero deps · offline cards JSON",
        ],
        cta_line="See what’s actually due — not what you hoarded.",
        cta_cmd="npx @bhaskarauthor/learn-loop",
        footer="MIT  ·  offline SRS core  ·  not a full LMS",
        term_highlight=["DUE", "interval", "ef=", "reps=", "due"],
    ),
    "cyber-smb-shield": DocStory(
        slug="cyber-smb-shield",
        npm="@bhaskarauthor/cyber-smb-shield",
        accent=RED,
        cold_claim="MFA on. Backups untested. 11 of 40 clicked the phish.",
        cold_cards=[
            ("ok", "MFA", "enabled", GREEN),
            ("gap", "backups · patching", "not in place", RED),
            ("phish", "11/40 clicks", "27% · HIGH", RED),
        ],
        chapter1_title="01  ·  THE FAIR STORY",
        chapter1_lines=[
            "SMBs buy one tool and call it security.",
            "No tested restore. No patch cadence.",
            "Phish land because training was a poster.",
            "",
            "Score the baseline.",
            "Then train where clicks hurt.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "One ransomware week ends the company story.",
            "Weak band + high click rate is a prediction.",
            "Fix controls before the real attachment arrives.",
        ],
        proof_label="LIVE EVIDENCE  ·  score + phishing",
        discipline_title="Score baseline controls — not hope.",
        discipline_bullets=[
            "mfa · backups · dns · training · patching",
            "phishing click rate band",
            "weak / fair / strong",
        ],
        cta_line="See if you’re weak before the phish does.",
        cta_cmd="npx @bhaskarauthor/cyber-smb-shield",
        footer="MIT  ·  offline score core  ·  not a full MDR",
        term_highlight=["GAP", "OK", "HIGH", "weak", "fair", "strong", "phishing"],
    ),
    "data-quality-guard": DocStory(
        slug="data-quality-guard",
        npm="@bhaskarauthor/data-quality-guard",
        accent=AMBER,
        cold_claim="Pipeline green. Empty emails, duplicate ids, amount=-5.",
        cold_cards=[
            ("null", "email empty", "not_null FAIL", RED),
            ("dup", "id o3 twice", "unique FAIL", RED),
            ("range", "amount -5 / 99999", "range FAIL", RED),
        ],
        chapter1_title="01  ·  THE GREEN PIPELINE",
        chapter1_lines=[
            "Job succeeded.",
            "Dashboard refreshed.",
            "The money column has a negative and a duplicate key.",
            "",
            "Tests for code exist.",
            "Expectations for rows are still optional.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Bad data makes smart models look stupid.",
            "Gate not_null · unique · range before load.",
            "RED suite beats a Friday war room.",
        ],
        proof_label="LIVE EVIDENCE  ·  expectations",
        discipline_title="Gate rows like you gate tests.",
        discipline_bullets=[
            "not_null · unique · range",
            "PASS/FAIL with bad counts",
            "suite GREEN or RED",
        ],
        cta_line="Fail the load when expectations fail.",
        cta_cmd="npx @bhaskarauthor/data-quality-guard",
        footer="MIT  ·  offline expectations core  ·  not a full DQ platform",
        term_highlight=["FAIL", "PASS", "RED", "GREEN", "bad="],
    ),
    "care-companion": DocStory(
        slug="care-companion",
        npm="@bhaskarauthor/care-companion",
        accent=(74, 222, 128),
        cold_claim="Two meds due now. One next week. Schedules beat nag spam.",
        cold_cards=[
            ("due", "Metformin 500", "due now", RED),
            ("due", "Atorvastatin", "due now", AMBER),
            ("later", "Vitamin D", "next week", GREEN),
        ],
        chapter1_title="01  ·  THE MISSED DOSE",
        chapter1_lines=[
            "App sends ten reminders.",
            "None know what is actually due.",
            "Caregiver guesses from a paper strip.",
            "",
            "Adherence is a schedule.",
            "Not notification volume.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Missed chronic meds compound quietly.",
            "Due list + nextAt by interval is the spine.",
            "Local-first fits family care reality.",
        ],
        proof_label="LIVE EVIDENCE  ·  due + next",
        discipline_title="Due list. Then reschedule.",
        discipline_bullets=[
            "meds with everyHours + nextAt",
            "due now filter",
            "scheduleNext advances interval",
        ],
        cta_line="See what is due — not what you forgot.",
        cta_cmd="npx @bhaskarauthor/care-companion",
        footer="MIT  ·  offline schedule core  ·  not a full EMR",
        term_highlight=["DUE", "NEXT", "due now", "every="],
    ),
    "personal-crm": DocStory(
        slug="personal-crm",
        npm="@bhaskarauthor/personal-crm",
        accent=CYAN,
        cold_claim="Investor silent 38 days. Lead: never touched.",
        cold_cards=[
            ("nudge", "Priya investor", "38d silent", AMBER),
            ("nudge", "Sam lead", "never", RED),
            ("ok", "Maya peer", "recent", GREEN),
        ],
        chapter1_title="01  ·  THE COLD NETWORK",
        chapter1_lines=[
            "Contacts live in phone notes.",
            "You remember when it’s too late.",
            "A lead goes quiet for a month.",
            "",
        ...
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Missed nudges become missed rounds and intros.",
            "lastTouch + window = honest list.",
            "Personal CRM is discipline — not another SaaS login.",
        ],
        proof_label="LIVE EVIDENCE  ·  nudge list",
        discipline_title="Nudge when lastTouch is stale.",
        discipline_bullets=[
            "people + lastTouch",
            "window days → nudge list",
            "Local · zero deps · offline JSON",
        ],
        cta_line="See who went cold — before the deal does.",
        cta_cmd="npx @bhaskarauthor/personal-crm",
        footer="MIT  ·  offline nudge core  ·  not a full CRM suite",
        term_highlight=["NUDGE", "OK", "silent", "never", "need touch"],
    ),
    "creator-ops": DocStory(
        slug="creator-ops",
        npm="@bhaskarauthor/creator-ops",
        accent=PINK,
        cold_claim="Pipeline $33.5k. Two shoots overlap. Cash meets chaos.",
        cold_cards=[
            ("deal", "signed BankX", "$15k", GREEN),
            ("deal", "pitch x2", "still open", AMBER),
            ("clash", "shoot-a ↔ shoot-b", "calendar conflict", RED),
        ],
        chapter1_title="01  ·  THE CREATOR MESS",
        chapter1_lines=[
            "Deals in DMs.",
            "Shoots in a notes app.",
            "Two brands booked the same afternoon.",
            "",
            "Pipeline value without calendar truth is fiction.",
            "Conflicts are lost trust and lost cash.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Double-books end brand relationships.",
            "Stage counts + conflict pairs in one pass.",
            "Ops is the product behind the content.",
        ],
        proof_label="LIVE EVIDENCE  ·  pipeline + clashes",
        discipline_title="Pipeline value. Then conflict scan.",
        discipline_bullets=[
            "deals by stage · pipelineValue",
            "calendar overlap pairs",
            "Local · zero deps · offline JSON",
        ],
        cta_line="See the clash before the shoot day.",
        cta_cmd="npx @bhaskarauthor/creator-ops",
        footer="MIT  ·  offline ops core  ·  not a full agency OS",
        term_highlight=["CLASH", "pipeline", "conflicts", "signed", "pitch"],
    ),
    "climate-ops-meter": DocStory(
        slug="climate-ops-meter",
        npm="@bhaskarauthor/climate-ops-meter",
        accent=GREEN,
        cold_claim="Electricity, diesel, flights, waste — one kgCO2e number.",
        cold_cards=[
            ("elec", "4200 kWh", "HQ power", AMBER),
            ("diesel", "180 L", "genset", RED),
            ("flight", "6400 km", "BOM-DEL legs", AMBER),
        ],
        chapter1_title="01  ·  THE UNMEASURED",
        chapter1_lines=[
            "Ops runs on fuel and flights.",
            "Reports wait for a consultant.",
            "Hotspots stay invisible.",
            "",
            "You can’t cut what you never measured.",
            "Factor × amount is the first meter.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Unmetered emissions become surprise targets.",
            "Simple factors beat perfect models that never ship.",
            "Local rollup for teams that need a number now.",
        ],
        proof_label="LIVE EVIDENCE  ·  emissions rollup",
        discipline_title="Factor × amount → kgCO2e.",
        discipline_bullets=[
            "electricity · diesel · flight · waste",
            "line kg + total tCO2e",
            "hotspot = top line",
        ],
        cta_line="Meter the ops before the audit asks.",
        cta_cmd="npx @bhaskarauthor/climate-ops-meter",
        footer="MIT  ·  offline factor core  ·  not a full ESG suite",
        term_highlight=["kg", "total", "hotspot", "electricity", "diesel", "flight"],
    ),
    "sc-visibility-lite": DocStory(
        slug="sc-visibility-lite",
        npm="@bhaskarauthor/sc-visibility-lite",
        accent=ORANGE,
        cold_claim="Two high-risk suppliers. One never checked in.",
        cold_cards=[
            ("high", "Fabric Mill A", "stale check-in", RED),
            ("high", "Logistics D", "never checked in", RED),
            ("ok", "Pack Co C", "fresh · low risk", GREEN),
        ],
        chapter1_title="01  ·  THE BLIND TIER",
        chapter1_lines=[
            "Brand story says ethical supply.",
            "Tier-2 mill hasn’t checked in for weeks.",
            "Logistics partner: lastCheckin = 0.",
            "",
            "Visibility is risk bands + freshness.",
            "Not a PDF from last year.",
        ],
        chapter2_title="02  ·  THE COST",
        chapter2_lines=[
            "Blind suppliers become recall headlines.",
            "High risk + stale check-in is the red combo.",
            "Lite visibility before enterprise SCM spend.",
        ],
        proof_label="LIVE EVIDENCE  ·  risk + stale",
        discipline_title="Risk band. Stale window.",
        discipline_bullets=[
            "suppliers · risk low/med/high",
            "stale if lastCheckin > maxDays",
            "Local · zero deps · offline JSON",
        ],
        cta_line="See who went dark in the chain.",
        cta_cmd="npx @bhaskarauthor/sc-visibility-lite",
