...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`care-companion (P22) — Family care coordination app: meds, appointments, shared notes for elders

Usage:
  care-companion [--json] [fixture.json]
  care-companion --help
...
if (json) console.log(JSON.stringify({ product: "care-companion", id: "P22", result }, null, 2));
else {
  console.log("care-companion · P22");
